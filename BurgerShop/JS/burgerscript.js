...
function burgerOfTheDay(){
	...
	switch(random){
		...
		case 3:{
			curst='soft',filling='panner',toppings=['cucumber','meat'];
			makeCall(toppings.length);
			break;
		}
		case 4:{
		...
		case 7:{
			curst='thin',filling='chicken',toppings=['tomato','cucumber','cabbage'];
			makeCall(toppings.length);
			break;
		}
	}
...
function displayInbox(){	
	...
	if(offerTopping){
		...
		var outToppings=$('<h4/>').text('Toppings is '+toppings+' 	 Price is '+toppingAmount);
	}
